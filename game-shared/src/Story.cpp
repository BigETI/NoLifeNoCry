...
{
	std::shared_ptr<NoLifeNoCry::Engine::Serialiser::Asset<StoryData>> story_asset(NoLifeNoCry::Engine::Serialiser::Asset<NoLifeNoCry::Game::StoryData>::Load((std::filesystem::path("./assets/stories") / (storyName + ".xml")).string()));
