...
namespace NoLifeNoCry::Engine
{
	...
	class Image : public sf::Image
	{
        ...
        void Create(unsigned int width, unsigned int height, const NoLifeNoCry::Engine::Color& color = NoLifeNoCry::Engine::Color(0, 0, 0));
        ...
        /// @param color Color
        /// @param alpha Alpha
        void CreateMaskFromColor(const NoLifeNoCry::Engine::Color& color, std::uint8_t alpha = 0);
        ...
        void Copy(const NoLifeNoCry::Engine::Image& source, unsigned int destX, unsigned int destY, const NoLifeNoCry::Engine::Rectangle<int>& sourceRect = NoLifeNoCry::Engine::Rectangle<int>(0, 0, 0, 0), bool applyAlpha = false);

        /// @brief Set pixel color
        /// @param x X
        /// @param y Y
        /// @param color Color
        void SetPixel(unsigned int x, unsigned int y, const NoLifeNoCry::Engine::Color& color);

        /// @brief Get pixel color
        /// @param x X
        /// @param y Y
        /// @return Pixel color
        NoLifeNoCry::Engine::Color GetPixel(unsigned int x, unsigned int y) const;
