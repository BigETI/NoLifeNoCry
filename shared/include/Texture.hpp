...
namespace NoLifeNoCry::Engine
{
	...
	class Texture : sf::Texture
    {
        ...
        static void Bind(const NoLifeNoCry::Engine::Texture* texture, NoLifeNoCry::Engine::ECoordinateSpace coordinateSpace = NoLifeNoCry::Engine::ECoordinateSpace::Normalized);
        ...
        bool LoadFromFile(const std::string& path, const NoLifeNoCry::Engine::Rectangle<int>& area = NoLifeNoCry::Engine::Rectangle<int>());
        ...
        bool LoadFromMemory(const std::span<std::uint8_t, Extent> memory, const NoLifeNoCry::Engine::Rectangle<int>& area = NoLifeNoCry::Engine::Rectangle<int>())
        {
        ...
        bool LoadFromImage(const NoLifeNoCry::Engine::Image& image, const NoLifeNoCry::Engine::Rectangle<int>& area = NoLifeNoCry::Engine::Rectangle<int>());
        ...
        /// @param texture Texture
        void Update(const NoLifeNoCry::Engine::Texture& texture);

        /// @brief Update with texture
        /// @param texture Texture
        /// @param x X
        /// @param y Y
        void Update(const NoLifeNoCry::Engine::Texture& texture, unsigned int x, unsigned int y);

        /// @brief Update with image
        /// @param image Image
        void Update(const NoLifeNoCry::Engine::Image& image);

        /// @brief Update with image
        /// @param image Image
        /// @param x X
        /// @param y Y
        void Update(const NoLifeNoCry::Engine::Image& image, unsigned int x, unsigned int y);
        ...
        /// @param texture Texture
        /// @return Itself
        NoLifeNoCry::Engine::Texture& operator =(const NoLifeNoCry::Engine::Texture& texture);
	};
}
