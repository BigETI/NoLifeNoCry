...
NoLifeNoCry::Editor::EditorWindow::EditorWindow(std::size_t windowWidth, std::size_t windowHeight, const std::string& windowName, NoLifeNoCry::Engine::EWindowStyle windowStyle) : Window(windowWidth, windowHeight, windowName, windowStyle)
{
...
/// @brief Start editor
/// @return Exit code
NoLifeNoCry::Engine::EExitCode NoLifeNoCry::Editor::EditorWindow::Start()
{
